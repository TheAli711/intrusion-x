          ...
          <CardContent className="">
              ...
              <div className="grid grid-rows-2 place-items-start gap-y-48">
                <div className="grid auto-cols-max grid-flow-col gap-x-32">
                  <div className="place-self-center w-96">
                    <img className="w-96" src="assets/images/logo/intrusionx-logo.png" alt="lozgo" />
                  </div>
            ...
            <div className="mt-64">
              ...
              <div className="flex items-start mt-16">
                <img className="flex-0 w-40 mt-8" src="assets/images/logo/intrusionx-logo.png" alt="logo" />
